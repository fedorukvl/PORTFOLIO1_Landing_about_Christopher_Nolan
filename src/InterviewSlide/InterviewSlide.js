...
class InterviewSlide extends React.Component {
	constructor(props) {
		...
		this.state = {
			movie: [
				{
					movieName: "Бэтмен: Начало",
					url: "https://www.kinopoisk.ru/film/47237/",
					plot:
		...
		return (
			<div className="interviewSlide">
				<div className="interviewContainer">
					<h1
						className="prevMovie"
						onClick={this.showNextMovie.bind(this)}
					>
						&lt;
					</h1>
					...
					<div className="textContainer">
						<MovieColumn
							movieTitle={
								this.state.movie[this.state.currentIndex]
									.movieName
							}
							moviePlot={
								this.state.movie[this.state.currentIndex].plot
							}
							movieUrl={
								this.state.movie[this.state.currentIndex].url
							}
						/>
					</div>
